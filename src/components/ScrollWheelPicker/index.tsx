...
const WHEEL_BASE = 'relative w-full overflow-hidden select-none touch-none cursor-grab active:cursor-grabbing ' +
  '[perspective:900px] ' +
  '[mask-image:linear-gradient(to_bottom,transparent_0%,rgba(0,0,0,0.3)_12%,black_28%,black_72%,rgba(0,0,0,0.3)_88%,transparent_100%)] ' +
  '[-webkit-mask-image:linear-gradient(to_bottom,transparent_0%,rgba(0,0,0,0.3)_12%,black_28%,black_72%,rgba(0,0,0,0.3)_88%,transparent_100%)]';
