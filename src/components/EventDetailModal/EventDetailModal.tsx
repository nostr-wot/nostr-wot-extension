      ...
      <div className={CLS.content}>
        ...
        {nip46InFlight && request && onDeny && (
          <div className={CLS.actions}>
            <Button variant="danger" small disabled={busy} onClick={onDeny}>
        ...
        {isApproval && (
          <div className={CLS.actions}>
            <div className={CLS.actionsRow}>
              <Button variant="danger" small disabled={busy} onClick={onAlwaysDeny}>
                {t('approval.alwaysDenyLabel', { label: title })}
              </Button>
              <Button variant="secondary" small disabled={busy} onClick={onDeny}>
                {t('approval.deny')}
              </Button>
            </div>
            <div className={CLS.actionsRow}>
              <Button variant="secondary" small disabled={busy} onClick={onAlwaysAllow}>
